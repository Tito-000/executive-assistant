...
1. **Proyecto Anabel Mercedes** — marca personal + contenido + ManyChat + landing. Deadline: 5 abr 2026
...
## Urgente (PAST_DUE)
- Instalar Google Tag Manager (Memorama)
- Configurar eventos principales — lead, WhatsApp, llamada (Memorama)
- Instalar GA4 (Memorama)
- Probar eventos y conversiones (Memorama)
- Hacer automatización de WS en Koomo (Memorama)

_Actualiza este archivo cuando tu foco cambie._
