...
`[Master Prompt Reference Guide](.claude/skills/nano-banana-images/master_prompt_reference.md)`
...
2. A JSON prompt file matching the **Dense Narrative Format** saved in `scripts/nano-banana-images/`.
...
```bash
python3 scripts/nano-banana-images/generate_kie.py scripts/nano-banana-images/your_prompt.json outputs/nano-banana-images/output_image.jpg "4:5"
```
